...
$msg="";
  ...
  if(isset($_POST['reset_password']))
  {
      ...
      if($reset_password && $reenter_new_password =="")
      {
        $msg= "all fields are required";
      }
      elseif($reset_password == $reenter_new_password)
      {
        $sql9= "UPDATE `user` SET `password` = '$reset_password' WHERE token= '$reset_token'";
      
        $value9= mysqli_query($connect,$sql9);
        if($value9){
                  ...
                  <form method="POST" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="reset_password" class="form-control" id="reset_password" required>
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="reenter_new_password" class="form-control" id="reenter_new_password" required>
